...
module NIOSII_Test_mm_interconnect_0 (
		...
		input  wire        button_passthrough_reset_reset_bridge_in_reset_reset,           //       button_passthrough_reset_reset_bridge_in_reset.reset
	...
	wire    [7:0] cmd_mux_001_src_channel;                                                                             // cmd_mux_001:src_channel -> audio_0_avalon_audio_slave_agent:cp_channel
	...
	wire  [107:0] cmd_mux_002_src_data;                                                                                // cmd_mux_002:src_data -> audio_and_video_config_0_avalon_av_config_slave_agent:cp_data
	wire          cmd_mux_002_src_ready;                                                                               // audio_and_video_config_0_avalon_av_config_slave_agent:cp_ready -> cmd_mux_002:src_ready
	wire    [7:0] cmd_mux_002_src_channel;                                                                             // cmd_mux_002:src_channel -> audio_and_video_config_0_avalon_av_config_slave_agent:cp_channel
	...
	wire  [108:0] button_passthrough_s1_agent_rf_source_data;                                                          // button_passthrough_s1_agent:rf_source_data -> button_passthrough_s1_agent_rsp_fifo:in_data
	...
	wire  [108:0] button_passthrough_s1_agent_rsp_fifo_out_data;                                                       // button_passthrough_s1_agent_rsp_fifo:out_data -> button_passthrough_s1_agent:rf_sink_data
	...
	wire  [107:0] cmd_mux_007_src_data;                                                                                // cmd_mux_007:src_data -> button_passthrough_s1_agent:cp_data
	wire          cmd_mux_007_src_ready;                                                                               // button_passthrough_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire    [7:0] cmd_mux_007_src_channel;                                                                             // cmd_mux_007:src_channel -> button_passthrough_s1_agent:cp_channel
	...
	wire  [107:0] audio_and_video_config_0_avalon_av_config_slave_agent_rp_data;                                       // audio_and_video_config_0_avalon_av_config_slave_agent:rp_data -> router_005:sink_data
	...
	wire  [107:0] button_passthrough_s1_agent_rp_data;                                                                 // button_passthrough_s1_agent:rp_data -> router_010:sink_data
	...
	wire  [107:0] cmd_demux_001_src1_data;                                                                             // cmd_demux_001:src1_data -> crosser:in_data
	wire          cmd_demux_001_src1_ready;                                                                            // crosser:in_ready -> cmd_demux_001:src1_ready
	wire    [7:0] cmd_demux_001_src1_channel;                                                                          // cmd_demux_001:src1_channel -> crosser:in_channel
	...
	wire  [107:0] cmd_demux_001_src7_data;                                                                             // cmd_demux_001:src7_data -> crosser_002:in_data
	wire          cmd_demux_001_src7_ready;                                                                            // crosser_002:in_ready -> cmd_demux_001:src7_ready
	wire    [7:0] cmd_demux_001_src7_channel;                                                                          // cmd_demux_001:src7_channel -> crosser_002:in_channel
	...
	wire  [107:0] crosser_002_out_data;                                                                                // crosser_002:out_data -> cmd_mux_007:sink0_data
	wire          crosser_002_out_ready;                                                                               // cmd_mux_007:sink0_ready -> crosser_002:out_ready
	wire    [7:0] crosser_002_out_channel;                                                                             // crosser_002:out_channel -> cmd_mux_007:sink0_channel
	...
	wire  [107:0] rsp_demux_002_src0_data;                                                                             // rsp_demux_002:src0_data -> crosser_004:in_data
	wire          rsp_demux_002_src0_ready;                                                                            // crosser_004:in_ready -> rsp_demux_002:src0_ready
	wire    [7:0] rsp_demux_002_src0_channel;                                                                          // rsp_demux_002:src0_channel -> crosser_004:in_channel
	...
	wire    [7:0] crosser_004_out_channel;                                                                             // crosser_004:out_channel -> rsp_mux_001:sink2_channel
	...
	wire  [107:0] rsp_demux_007_src0_data;                                                                             // rsp_demux_007:src0_data -> crosser_005:in_data
	...
	wire          crosser_005_out_valid;                                                                               // crosser_005:out_valid -> rsp_mux_001:sink7_valid
	wire  [107:0] crosser_005_out_data;                                                                                // crosser_005:out_data -> rsp_mux_001:sink7_data
	wire          crosser_005_out_ready;                                                                               // rsp_mux_001:sink7_ready -> crosser_005:out_ready
	wire    [7:0] crosser_005_out_channel;                                                                             // crosser_005:out_channel -> rsp_mux_001:sink7_channel
	wire          crosser_005_out_startofpacket;                                                                       // crosser_005:out_startofpacket -> rsp_mux_001:sink7_startofpacket
	wire          crosser_005_out_endofpacket;                                                                         // crosser_005:out_endofpacket -> rsp_mux_001:sink7_endofpacket
	...
	altera_merlin_slave_translator #(
		...
		.reset                  (button_passthrough_reset_reset_bridge_in_reset_reset), //                    reset.reset
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (video_pll_0_vga_clk_clk),                                //             clk.clk
		.reset                   (button_passthrough_reset_reset_bridge_in_reset_reset),   //       clk_reset.reset
	...
	NIOSII_Test_mm_interconnect_0_rsp_demux_007 rsp_demux_007 (
		.clk                (video_pll_0_vga_clk_clk),                              //       clk.clk
		.reset              (button_passthrough_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.out_reset         (button_passthrough_reset_reset_bridge_in_reset_reset), // out_clk_reset.reset
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.in_reset          (button_passthrough_reset_reset_bridge_in_reset_reset), //  in_clk_reset.reset
		.out_clk           (clk_0_clk_clk),                                        //       out_clk.clk
		.out_reset         (nios2_gen2_0_reset_reset_bridge_in_reset_reset),       // out_clk_reset.reset
	...
	NIOSII_Test_mm_interconnect_0_avalon_st_adapter_001 #(
		...
		.in_rst_0_reset (button_passthrough_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
