...
module NIOSII_Test_mm_interconnect_0 (
	...
	wire  [115:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> nios2_gen2_0_debug_mem_slave_agent:cp_data
	...
	wire  [115:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> onchip_memory2_0_s1_agent:cp_data
	...
	wire  [115:0] onchip_memory2_0_s1_agent_rp_data;                                                  // onchip_memory2_0_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [115:0] new_sdram_controller_0_s1_agent_rp_data;                                            // new_sdram_controller_0_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [115:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> new_sdram_controller_0_s1_burst_adapter:sink0_data
	wire          cmd_mux_004_src_ready;                                                              // new_sdram_controller_0_s1_burst_adapter:sink0_ready -> cmd_mux_004:src_ready
	wire    [4:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> new_sdram_controller_0_s1_burst_adapter:sink0_channel
	...
	wire  [115:0] cmd_demux_001_src0_data;                                                            // cmd_demux_001:src0_data -> cmd_mux_002:sink1_data
	...
	wire  [115:0] cmd_demux_001_src1_data;                                                            // cmd_demux_001:src1_data -> cmd_mux_003:sink1_data
	...
	wire  [115:0] cmd_demux_002_src0_data;                                                            // cmd_demux_002:src0_data -> cmd_mux_004:sink2_data
	...
	wire  [115:0] rsp_demux_002_src1_data;                                                            // rsp_demux_002:src1_data -> rsp_mux_001:sink0_data
	...
	wire  [115:0] rsp_demux_003_src1_data;                                                            // rsp_demux_003:src1_data -> rsp_mux_001:sink1_data
	...
	wire  [115:0] rsp_demux_004_src2_data;                                                            // rsp_demux_004:src2_data -> rsp_mux_002:sink0_data
	...
	wire    [4:0] rsp_mux_002_src_channel;                                                            // rsp_mux_002:src_channel -> alt_vip_cl_vfb_0_mem_master_rd_rsp_width_adapter:in_channel
	...
	wire    [4:0] alt_vip_cl_vfb_0_mem_master_rd_rsp_width_adapter_src_channel;                       // alt_vip_cl_vfb_0_mem_master_rd_rsp_width_adapter:out_channel -> alt_vip_cl_vfb_0_mem_master_rd_agent:rp_channel
	...
	wire    [4:0] router_002_src_channel;                                                             // router_002:src_channel -> alt_vip_cl_vfb_0_mem_master_rd_cmd_width_adapter:in_channel
	...
	wire    [4:0] alt_vip_cl_vfb_0_mem_master_rd_cmd_width_adapter_src_channel;                       // alt_vip_cl_vfb_0_mem_master_rd_cmd_width_adapter:out_channel -> cmd_demux_002:sink_channel
	...
	wire  [115:0] rsp_demux_src0_data;                                                                // rsp_demux:src0_data -> crosser_001:in_data
	...
	wire  [115:0] crosser_001_out_data;                                                               // crosser_001:out_data -> rsp_mux:sink0_data
	...
	NIOSII_Test_mm_interconnect_0_router_007 router_007 (
	...
	NIOSII_Test_mm_interconnect_0_cmd_mux_004 cmd_mux_004 (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                            //       clk.clk
		.reset               (alt_vip_cl_vfb_0_mem_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOSII_Test_mm_interconnect_0_rsp_demux_004 rsp_demux_004 (
		.clk                (sys_sdram_pll_0_sys_clk_clk),                            //       clk.clk
		.reset              (alt_vip_cl_vfb_0_mem_reset_reset_bridge_in_reset_reset), // clk_reset.reset
