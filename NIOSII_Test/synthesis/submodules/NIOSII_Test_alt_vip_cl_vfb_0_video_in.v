// NIOSII_Test_alt_vip_cl_vfb_0_video_in.v
...
`timescale 1 ps / 1 ps
module NIOSII_Test_alt_vip_cl_vfb_0_video_in (
		input  wire        main_clock_clk,              //    main_clock.clk
		input  wire        main_reset_reset,            //    main_reset.reset
		input  wire [29:0] av_st_vid_din_data,          // av_st_vid_din.data
		...
		output wire [61:0] av_st_dout_data,             //              .data
		input  wire        av_st_dout_ready             //              .ready
	);

	wire         vid_front_av_st_dout_valid;         // vid_front:av_st_dout_valid -> vid_back:av_st_din_valid
	wire  [61:0] vid_front_av_st_dout_data;          // vid_front:av_st_dout_data -> vid_back:av_st_din_data
