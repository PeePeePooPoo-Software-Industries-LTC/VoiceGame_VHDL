// NIOSII_Test_mm_interconnect_1.v
...
`timescale 1 ps / 1 ps
module NIOSII_Test_mm_interconnect_1 (
	...
	wire  [361:0] rsp_mux_src_data;                                                                  // rsp_mux:src_data -> alt_vip_cl_vfb_0_mem_master_rd_agent:rp_data
	wire          rsp_mux_src_ready;                                                                 // alt_vip_cl_vfb_0_mem_master_rd_agent:rp_ready -> rsp_mux:src_ready
	wire    [0:0] rsp_mux_src_channel;                                                               // rsp_mux:src_channel -> alt_vip_cl_vfb_0_mem_master_rd_agent:rp_channel
	...
	wire  [361:0] alt_vip_cl_vfb_0_mem_master_rd_agent_cp_data;                                      // alt_vip_cl_vfb_0_mem_master_rd_agent:cp_data -> router:sink_data
	...
	wire  [109:0] new_sdram_controller_0_s1_agent_rp_data;                                           // new_sdram_controller_0_s1_agent:rp_data -> router_001:sink_data
	...
	wire  [109:0] new_sdram_controller_0_s1_burst_adapter_source0_data;                              // new_sdram_controller_0_s1_burst_adapter:source0_data -> new_sdram_controller_0_s1_agent:cp_data
	...
	wire  [109:0] router_001_src_data;                                                               // router_001:src_data -> new_sdram_controller_0_s1_rsp_width_adapter:in_data
	...
	wire  [361:0] new_sdram_controller_0_s1_rsp_width_adapter_src_data;                              // new_sdram_controller_0_s1_rsp_width_adapter:out_data -> rsp_demux:sink_data
	...
	wire  [361:0] cmd_mux_src_data;                                                                  // cmd_mux:src_data -> new_sdram_controller_0_s1_cmd_width_adapter:in_data
	...
	wire  [109:0] new_sdram_controller_0_s1_cmd_width_adapter_src_data;                              // new_sdram_controller_0_s1_cmd_width_adapter:out_data -> new_sdram_controller_0_s1_burst_adapter:sink0_data
	...
	NIOSII_Test_mm_interconnect_1_router router (
	...
	NIOSII_Test_mm_interconnect_1_router_001 router_001 (
	...
	NIOSII_Test_mm_interconnect_1_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                          //       clk.clk
		.reset              (alt_vip_cl_vfb_0_mem_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOSII_Test_mm_interconnect_1_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                          //       clk.clk
		.reset               (alt_vip_cl_vfb_0_mem_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOSII_Test_mm_interconnect_1_cmd_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                                 //       clk.clk
		.reset              (alt_vip_cl_vfb_0_mem_reset_reset_bridge_in_reset_reset),        // clk_reset.reset
	...
	NIOSII_Test_mm_interconnect_1_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                          //       clk.clk
		.reset               (alt_vip_cl_vfb_0_mem_reset_reset_bridge_in_reset_reset), // clk_reset.reset
