// NIOSII_Test_alt_vip_cl_vfb_0.v
...
`timescale 1 ps / 1 ps
module NIOSII_Test_alt_vip_cl_vfb_0 #(
		...
		parameter MEM_BASE_ADDR                = 1048576,
		...
		input  wire [29:0]  din_data,                    //           din.data
	...
	wire  [61:0] video_in_av_st_dout_data;              // video_in:av_st_dout_data -> wr_ctrl:vib_data_data
	...
	wire  [61:0] wr_ctrl_pkt_wr_data_data;              // wr_ctrl:pkt_wr_data_data -> pkt_trans_wr:av_st_din_data
	...
	wire  [61:0] rd_ctrl_vob_data_data;                 // rd_ctrl:vob_data_data -> video_out:av_st_din_data
	...
	wire  [61:0] pkt_trans_rd_av_st_dout_data;          // pkt_trans_rd:av_st_dout_data -> rd_ctrl:pkt_rd_data_data
	...
	NIOSII_Test_alt_vip_cl_vfb_0_video_in video_in (
