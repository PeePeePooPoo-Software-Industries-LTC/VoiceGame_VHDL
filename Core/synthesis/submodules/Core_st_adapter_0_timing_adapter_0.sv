...
//   output_name:        Core_st_adapter_0_timing_adapter_0
//   in_use_ready:       true
//   out_use_ready:      true
//   in_use_valid:       true
//   out_use_valid:      true
...
module Core_st_adapter_0_timing_adapter_0
(  
 output reg         in_ready,
 input               in_valid,
 ...
 /*AUTOARG*/);
   ...
   //| FIFO
   // ---------------------------------------------------------------------                           
   Core_st_adapter_0_timing_adapter_0_fifo Core_st_adapter_0_timing_adapter_0_fifo 
     ( 
       .clk        (clk),
       .reset_n    (reset_n),
       .in_ready   (),
