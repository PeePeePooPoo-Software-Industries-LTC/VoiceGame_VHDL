...
# ----------------------------------------
# If ClockedAudioInput is one of several IP cores in your
...
# ----------------------------------------
# ACDS 18.1 625 linux 2023.11.22.13:37:07
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "ClockedAudioInput"
}
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "/home/jaschutte/Applications/Quartus/quartus/"
}
...
ensure_lib                   ./libraries/ClockedAudioInput/
vmap       ClockedAudioInput ./libraries/ClockedAudioInput/
...
alias com {
  echo "\[exec\] com"
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/clocked_audio_input/mentor/cai_avalon.v"                    -work ClockedAudioInput
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/clocked_audio_input/mentor/cai_registers.v"                 -work ClockedAudioInput
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/clocked_audio_input/mentor/altera_cai_reset_synchronizer.v" -work ClockedAudioInput
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/clocked_audio_input/mentor/clocked_audio_input.v"           -work ClockedAudioInput
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS    "$QSYS_SIMDIR/ClockedAudioInput.vhd"                                                             
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L ClockedAudioInput -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneive $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L ClockedAudioInput -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneive $TOP_LEVEL_NAME
}
