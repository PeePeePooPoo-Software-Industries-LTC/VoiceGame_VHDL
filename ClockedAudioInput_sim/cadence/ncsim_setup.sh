...
TOP_LEVEL_NAME="ClockedAudioInput"
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/home/jaschutte/Applications/Quartus/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
mkdir -p ./libraries/ClockedAudioInput/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/clocked_audio_input/cadence/cai_avalon.v"                    -work ClockedAudioInput -cdslib ./cds_libs/ClockedAudioInput.cds.lib
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/clocked_audio_input/cadence/cai_registers.v"                 -work ClockedAudioInput -cdslib ./cds_libs/ClockedAudioInput.cds.lib
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/clocked_audio_input/cadence/altera_cai_reset_synchronizer.v" -work ClockedAudioInput -cdslib ./cds_libs/ClockedAudioInput.cds.lib
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/clocked_audio_input/cadence/clocked_audio_input.v"           -work ClockedAudioInput -cdslib ./cds_libs/ClockedAudioInput.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/ClockedAudioInput.vhd"                                                                                                           
fi
